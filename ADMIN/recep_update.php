<?php
    ...
    $edit = "SELECT name,dob,age,gender,nic,email,address,tel,username,password FROM receptionist WHERE nic=$nic";
...
<head>
    ...
    <title>Update pecetionist data</title>
...
<!--background start-->
<div class="uk-height-medium uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light aru-lob" data-src="../imgs/lo7.jpg" uk-img>
 <div class="uk-box-shadow-bottom">
<div class="uk-container">
 
       <div class="ar-boxu">
        <h1>Receptionist Data Update</h1>
...
<form action="" method="POST">
   ...
   <p>Username:<input type="text" class="do" placeholder="Username" name="us" value="<?php echo $username?>" required></p>
      <p>Password:<input type="password" class="do" placeholder="Password" name="pw" value="<?php echo $password?>"  required></p>
        ...
        <button type="submit" class="aru-btn" name="aru-btn">Update</button>
...
<!---background end--->
  ...
  <?php
        if(isset($_POST["aru-btn"])){
            ...
            $edit2 = "UPDATE `receptionist` SET `name`='$name', `dob`='$dob', `age`='$age', `gender`='$gender', `nic`='$nnic', `email`='$email', `address`='$address', `tel`='$tel', `username`='$username', `password`='$password' WHERE `nic`=$nic;";
