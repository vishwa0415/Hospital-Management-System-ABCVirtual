...
<div uk-sticky>
<nav class="uk-navbar-container pnavi">
    <div class="uk-container ">
        <div uk-navbar>
            ...
            <div class="uk-navbar-left">
                ...
                <a href="../PATIENT/patient_dashbord.php">
    ...
    <div uk-drop="mode: click" class="col1">
        <div class="uk-card uk-card-body uk-card-default clo">
            ...
            <h1>Patient</h1>
            <p>You are viewing Patient dashbord now! <br>access your features. <br>ABC VIRTUAL Hospital (PVT) Ltd.</p>
             <form action="../LOGINS/patientlogin.php"><button class="uk-button uk-button-default btn2">LogOut</button></form>
        </div>
    </div>
</div>
...
<!--Navigation bar end-->
<div class="uk-height-medium uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light plob" data-src="../imgs/lo5.jpg" uk-img>

<!--content start-->
<div class="com-patient">
    <div class="uk-container">
        <br>
     <h1>HI!, Welcome to Patient Dashbord.</h1>
    ...
    <div class="uk-child-width-1-3@m uk-grid-small uk-grid-match cbb" uk-grid uk-scrollspy="cls: uk-animation-fade; target: .uk-card; delay: 500; repeat: true">
        ...
        <div>
        <div class="uk-card uk-card-default uk-width-1-1@m p-cb">
    <div class="uk-card-header colo">
        <div class="uk-grid-small uk-flex-middle" uk-grid>
           
            <div class="uk-width-expand hh">
                <h3 class="uk-card-title uk-margin-remove-bottom">Appoinment Booking</h3>
                <p class="uk-text-meta uk-margin-remove-top">ABC VIRTUAL</p>
            </div>
        </div>
    </div>
    
    <div class="uk-card-body p-bd">
           <ul class="uk-list uk-list-divider">
    <li> <a href="../PATIENT/appoinment_save.php"><p>Book an Appoinment</p></a></li>
    
</ul>
    </div>
    <div class="uk-card-footer foo-patient">
    ...
    <div class="uk-card-body p-bd">
       <ul class="uk-list uk-list-divider">
    <li><a href="../PATIENT/my_appoinments.php?mmn=$mm"><p>My Appoinments</p></a></li>
